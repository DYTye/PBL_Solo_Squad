...
public function definition()
{
    return [
        ...
        'jabatan' => $this->faker->randomElement(['Kepala Sekolah', 'Guru', 'Staff']),
        ...
        'jenis_ptk' => $this->faker->randomElement(['Guru Kelas', 'Guru Mapel', 'TU', 'Kepala Sekolah']),
        ...
        'tugas_tambahan' => $this->faker->optional()->randomElement(['Kepala Lab', 'Wakasek', 'Pembina OSIS']),

        'sudah_lisensi_kepala_sekolah' => $this->faker->boolean(30),
        ...
        'tmt_pns' => $this->faker->optional()->date('Y-m-d'),
        'sk_cpns' => $this->faker->optional()->bothify('SK-#####'),
        ...
        'pangkat_golongan' => $this->faker->randomElement(['III/a', 'III/b', 'IV/a', 'IV/b']),
        ...
        'nama_dusun' => $this->faker->streetName(),
