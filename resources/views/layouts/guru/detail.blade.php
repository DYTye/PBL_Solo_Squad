        ...
        <div class="card">
            <div class="card-body">
                <ul class="list-group mb-3">
                    <li class="list-group-item active">Detail Guru: </li>
                    ...
                    <li class="list-group-item"><strong>Status:</strong> {{ $guru->status ?? '-' }}</li>
                    ...
                    <li class="list-group-item active">Pasangan Guru: </li>
                    ...
                    <li class="list-group-item active">Kompetensi Guru: </li>
                    ...
                    <li class="list-group-item active">Alamat Guru: </li>
                    <li class="list-group-item"><strong>Jalan:</strong> {{ $guru->jalan ?? '-' }}</li>
                    <li class="list-group-item"><strong>RT:</strong> {{ $guru->rt ?? '-' }}</li>
                    <li class="list-group-item"><strong>RW:</strong> {{ $guru->rw ?? '-' }}</li>
                    <li class="list-group-item"><strong>Dusun:</strong> {{ $guru->nama_dusun ?? '-' }}</li>
                    <li class="list-group-item"><strong>Desa/Kelurahan:</strong> {{ $guru->desa_kelurahan ?? '-' }}</li>
                    <li class="list-group-item"><strong>Kecamatan:</strong> {{ $guru->kecamatan ?? '-' }}</li>
                    <li class="list-group-item"><strong>Kode Pos:</strong> {{ $guru->kode_pos ?? '-' }}</li>
                </ul>
